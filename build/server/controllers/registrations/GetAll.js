...
const getAll = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield registrations_1.registrationsProviders.getAll(Number(page) || 1, Number(limit) || 10, filter || '', Number(req.headers.IdUser));
    // Count all collaborators
    const count = yield registrations_1.registrationsProviders.count(filter || '', Number(req.headers.IdUser));
