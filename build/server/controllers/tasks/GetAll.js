...
const getAll = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield Tasks_1.tasksProviders.getAll(Number(page) || 1, Number(limit) || 10, filter || '', Number(req.headers.IdUser));
    // Count all collaborators
    const count = yield Tasks_1.tasksProviders.count(filter || '', Number(req.headers.IdUser));
