...
const deleteById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // Call the provider
    const result = yield Tasks_1.tasksProviders.deleteById(Number(req.params.id), Number(req.headers.IdUser));
    ...
    return res.status(201).json({ result: 'DELETED A TAKS.', id: result });
});
