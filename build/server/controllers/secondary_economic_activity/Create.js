...
const create = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // Call the provider
    const result = yield Secondary_economic_activity_1.secondary_economic_activityProviders.create(Object.assign(Object.assign({}, req.body), { id_company: Number(req.query.idCompany), id_user: Number(req.headers.IdUser) }));
