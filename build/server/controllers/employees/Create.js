...
const create = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // Call the provider
    const result = yield Employees_1.employeeProviders.create(Object.assign(Object.assign({}, req.body), { id_user: Number(req.headers.IdUser) }), Number(req.query.idCompany));
