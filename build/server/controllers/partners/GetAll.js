...
const Partners_1 = require("../../database/providers/Partners");
...
const getAll = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield Partners_1.partnersProviders.getAll(Number(page) || 1, Number(limit) || 10, filter || '', Number(req.headers.IdUser));
    // Count all collaborators
    const count = yield Partners_1.partnersProviders.count(filter || '', Number(req.headers.IdUser));
