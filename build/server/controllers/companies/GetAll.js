...
const getAll = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield Companies_1.companiesProviders.getAll(Number(page) || 1, Number(limit) || 10, filter || '', Number(req.headers.IdUser), Number(idCollaborator));
    // Count all collaborators
    const count = yield Companies_1.companiesProviders.count(filter || '', Number(req.headers.IdUser));
