...
const getAll = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield Address_1.addressProviders.getAll(Number(page) || 1, Number(limit) || 10, filter || '', Number(req.headers.IdUser));
    // Count all collaborators
    const count = yield Address_1.addressProviders.count(filter || '', Number(req.headers.IdUser));
