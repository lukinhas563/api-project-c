...
const Address_1 = require("../../database/providers/Address");
...
const create = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (req.query.idCompany) {
        result = yield Address_1.addressProviders.create(Object.assign(Object.assign({}, req.body), { id_user: Number(req.headers.IdUser), id_company: Number(req.query.idCompany) }));
    }
    else if (req.query.idPartner) {
        result = yield Address_1.addressProviders.create(Object.assign(Object.assign({}, req.body), { id_user: Number(req.headers.IdUser), id_partner: Number(req.query.idPartner) }));
    }
    else {
        result = yield Address_1.addressProviders.create(Object.assign(Object.assign({}, req.body), { id_user: Number(req.headers.IdUser), id_employee: Number(req.query.idEmployee) }));
    }
