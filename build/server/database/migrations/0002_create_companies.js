...
function up(knex) {
    return __awaiter(this, void 0, void 0, function* () {
        return knex.schema
            .createTable(ETablesNames_1.EnumTableNames.companies, (table) => {
            ...
            .then(() => {
            console.log(`# Create table ${ETablesNames_1.EnumTableNames.companies}`);
        });
    });
}
exports.up = up;
function down(knex) {
    return __awaiter(this, void 0, void 0, function* () {
        return knex.schema
            .dropTable(ETablesNames_1.EnumTableNames.companies)
            .then(() => console.log(`# Dropped table ${ETablesNames_1.EnumTableNames.companies}`));
    });
}
exports.down = down;
