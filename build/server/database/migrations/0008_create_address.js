...
function up(knex) {
    return __awaiter(this, void 0, void 0, function* () {
        return knex.schema
            .createTable(ETablesNames_1.EnumTableNames.address, (table) => {
            ...
            .then(() => {
            console.log(`# Create table ${ETablesNames_1.EnumTableNames.address}`);
        });
    });
}
exports.up = up;
function down(knex) {
    return __awaiter(this, void 0, void 0, function* () {
        return knex.schema
            .dropTable(ETablesNames_1.EnumTableNames.address)
            .then(() => console.log(`# Dropped table ${ETablesNames_1.EnumTableNames.address}`));
    });
}
exports.down = down;
